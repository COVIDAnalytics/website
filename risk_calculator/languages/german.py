...
class German(CalcLanguage):
    ...
    def prompt_missing_feature(self, feature):
        return "Bitte geben Sie einen Wert für {} ein.".format(self.get_feature_names()[feature])
    ...
    def get_page_desc_mortality(self, labs_auc, no_labs_auc):
        return [
            html.H2("Datenanalyse kann das Sterblichkeitsrisiko errechnen"),
            html.Hr(),
            dcc.Markdown(
                ...
                der Patienten die Verfügbarkeit solcher Mittel überschreitet, müssen Ärzte schwere Entscheidungen \
            ...
            dcc.Markdown(
                """Rechenmodelle sind nur so gut wie ihre Trainingsdaten. Als die Menge der vorhandenen Daten von \
                 unseren Partnerinstitutionen zunimmt, werden wir neue Versionen von unseren Rechnern veröffentlichen. \
                 Falls Sie angehörig einer medizinischen Einrichtung sind und bereit sind einen \
    ...
    def get_page_desc_infection(self):
        return [
            html.H2("Datenanalyse kann infizierte Patienten identifizieren"),
            dcc.Markdown(
                """COVID-19 Tests sind zeitaufwändig, teuer und erfordern das Patienten Einrichtungen persönlich \
                     besuchen, wodurch sie möglicherweise dem Virus ausgesetzt werden können. \
                     Um symptomatische Patienten \
                     zu helfen, haben wir einen datengesteuerten Rechner entwickelt, der die Wahrscheinlichkeit \
            ...
            dcc.Markdown(
                """ **HINWEIS (Dies ist eine Entwicklungsversion!):** Rechenmodelle sind nur so gut wie ihre \
                     Trainingsdaten. Als die Menge der vorhandenen Daten von unserern Partnerinstiutionen zunimmt, \
        ...
        return [
            ...
            html.Div(
                [
                    ...
                    "Wenn Eingabewerte fehlen, schreibt der Rechner seine eigenen Werte zu und zeigt sie an."
                ]
            ),
            html.Br(),
            dcc.Markdown(
                """Wir nutzen [SHAP Graphen](https://github.com/slundberg/shap), \
                 ...
                 ihrer Wichtigkeit und Direktionalität zusammen. Die Charakteristiken werden nach abnehmender 
                 Wichtigkeit sortiert, mit der wichtigsten Charakteristik oben. Für eine gegeben Charakteristik zeigt 
                 die korrespondierende Grafik wie stark der Einfluss der Charakteristik auf das Endergebnis ist, 
                 mit rot als größter Einfluss und blau als kleinster. Höhere SHAP Werte entsprechen \
                 erhöhten Wahrscheinlichkeiten eines positiven Endergebnisses (z. B. Tod oder Infektion). \
        ...
        return [
            ...
            dcc.Markdown(
                """
                 ...
                 die Kliniken in der italienischen Stadt Cremona besucht hatten, trainiert.
            ...
            dcc.Markdown(
                """Wir nutzen [SHAP Graphen](https://github.com/slundberg/shap), \
                 um unsere XGBoost Modelle zu interpretieren. Die SHAP Grafik unten fasst Charakteristiken nach \
                 ihrer Wichtigkeit und Direktionalität zusammen. Die Charakteristiken werden nach abnehmender \
                 Wichtigkeit sortiert, mit der wichtigsten Charakteristik oben. Für eine gegeben Charakteristik \
                 zeigt die korrespondierende Grafik wie stark der Einfluss der Charakteristik auf das Endergebnis ist, \
                 mit rot nals größter Einfluss und blau als kleinster. Höhere SHAP Werte entsprechen erhöhten \
                 Wahrscheinlichkeiten eines positiven Endergebnisses (z. B. Tod oder Infektion). \
                 Charakteristiken mit dem Farbverlauf von blau zu rot (von links nach rechts) haben daher einen \
                 erhöhten Risikowert, wenn die Charakteristik steigt, sowie mit Alter. Charakteristiken die von rot \
                 zu blau verlaufen, haben einen niedrigeren Risikowert, wenn die Charakteristik steigt, sowie mit \
                 Sauerstoffsättigung. Hinweis: Geschlecht wird als Binärwert enkodiert (0=Männlich, 1=Weiblich), \
