...
def Projections_documentation():
    ...
    body = dbc.Container(className="page-body", children=[
        dbc.Row([
            dbc.Col([
                ...
                html.P("""
                    ...
                    SEIR (Susceptible-Exposed-Infected-Recovered) modeling approach, which allocates every person 
                    to one of four states:
                """),
                dcc.Markdown('''
                    1. Susceptible: The general population that has not been infected and is not immune.
                    2. Exposed: People who are currently infected, but are not contagious and lie within the incubation 
                    period.
                ...
                """),
                # In developing the XYZ model, we have greatly expanded a basic SEIR model and made adjustments for
                # many factors important
                dcc.Markdown('''
                    1. Effective contact rate: The effective contact rate measures the number of people that come into 
                    contact with an infected person per day. This fundamental quantity largely controls the spread of 
                    the virus, and would be greater in densely populated states (such as NY, CT) and smaller in 
                    sparsely populated ones (e.g. AZ, NV).
                    2. Societal/Governmental Response: This parameter measures, through a parametric nonlinear 
                    function, the impact of any governmental and societal responses on the spread of the virus over 
                    time. This includes such measures as government decrees regarding social distancing and 
                    sheltering-in-place, as well as increased hygiene-related awareness and reduced travel among 
                    the general population. This function is calibrated for every state to account 
