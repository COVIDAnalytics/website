...
def prompt_missing_feature(feature):
    return "Por favor inserte un valor para {}.".format(get_feature_names()[feature])
    ...
    return [
        ...
        dcc.Markdown(
            """ **NOTA (¡Esta es una versión de desarrollo!):** La precisión de los modelos depende \
             de la calidad de los datos con los que han sido creados. Lanzaremos nuevas versiones de la calculadora \
...
def get_model_desc_mortality(auc, pop, pos):
    return [
        ...
        dcc.Markdown(
            """* [Hartford HealthCare](https://hartfordhealthcare.org), una importante red de hospitales que atiende \
             a pacientes en todo Connecticut (EE. UU.). """,
        ),
        dcc.Markdown(
            """ Dada la demografía de nuestra base de datos, consideramos que nuestro modelo tiene mayor relevancia \
        ...
        html.Div([
            ...
            ".",
            html.Br(),
            "Si el usuario no dispone de información sobre todas las variables, nuestra calculadora les imputará un \
            valor e informará al usuario del mismo."
        ]),
        html.Br(),
        dcc.Markdown(
            ...
            Tomando como ejemplo la edad, se puede observar que el color varía de azul a rojo a medida que el valor \
            SHAP aumenta. Esto indíca que el riesgo de mortalidad o infección ese mayor \
